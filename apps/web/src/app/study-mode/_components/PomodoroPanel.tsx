...
import { Clock3, Pause, Play, RotateCcw, Target, TimerReset } from "lucide-react";
import { formatTime, getDurationForMode, modeLabel } from "./storage";
import type { PomodoroMode, PomodoroState, StudyTask } from "./types";
    ...
    <aside className="space-y-5">
      <section className="sticky top-0 rounded-2xl border border-[#232f48] bg-[#1a2332]/95 p-4 shadow-xl shadow-black/15 backdrop-blur">
        <div className="mb-4 flex items-center justify-between">
          ...
          <div className="rounded-xl bg-blue-500/10 p-2.5 text-blue-300 shadow-[0_0_18px_rgba(19,91,236,0.18)]">
            <Clock3 size={20} />
          </div>
        </div>
        ...
        {selectedTask ? (
          <>
            ...
            <div className="relative mx-auto mb-4 flex aspect-square max-w-[15rem] items-center justify-center rounded-full border border-[#232f48] bg-[#111722] shadow-inner">
              <div
